...
// Renate Ast, October 26, 2020, Lab 7.
// The purpose of this code is to execute the game RPSLS; to document the class and methods of the code AND to test the code.
